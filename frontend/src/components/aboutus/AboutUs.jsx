    ...
    <div className='about mt-3'>
      <div className='english'>
          ...
          "I insist on the equality of women with men. Every officer and soldier should insist upon the truth that woman is as important, as valuable, as capable and as necessary to the progress and happiness of the world as man.
           Unfortunately a large number of people of every tribe, class and nationality think otherwise. They still believe woman is inferior to man." These are the words of William Booth in his Messages to Soldiers, a book published in Britain in 1908.
           This shows the Gender Equality in the chruch from 1878 itself.
          </p>
